...
for t = t_range
    ...
    item5_1 = (1/R)*(-dHt0_1+da1*t+(db1/2)*(t.^2)+(dc1/3)*(t.^3)+(dd1/4)*(t.^4))*((1/t)-(1/T0));
    ...
    item5_2 = (1/R)*(-dHt0_2+da2*t+(db2/2)*(t.^2)+(dc2/3)*(t.^3)+(dd2/4)*(t.^4))*((1/t)-(1/T0));
    ...
    item5_3 = (1/R)*(-dHt0_3+da3*t+(db3/2)*(t.^2)+(dc3/3)*(t.^3)+(dd3/4)*(t.^4))*((1/t)-(1/T0));

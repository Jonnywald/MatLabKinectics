...
x0 = [300 10];
Values = fsolve(@(x)func(x,Ea,T0,Fa,Fa0,Vr,dHr,Cp,Xa,k1,Ca),x0);

temp = Values(1); %336.2379841934786e K
Heat = Values(2); %-30.044089623924478 KJ/s
...
function f=func(x,Ea,T0,Fa,Fa0,Vr,dHr,Cp,Xa,k1,Ca)
    T = x(1);
    k = k1*exp(-Ea * (1/T0 - 1/T));
    ra = k * Ca;
    Q = x(2);
    f(1) = Fa0 - Fa + ra*Vr;
